...
def main():
    ...
    rc1.on_red_up = lambda state: handle_red_up_1(
        state, dc)
    rc1.on_red_down = lambda state: handle_red_down_1(
        state, dc)
    rc1.on_blue_up = lambda state: handle_blue_up_1(
        state, dc)
    ...
    rc2.on_red_up = lambda state: handle_red_up_2(
        state, dc)

    rc3.on_red_up = lambda state: handle_red_up_3(
        state, dc)

    rc4.on_red_up = lambda state: handle_red_up_4(
        state, dc)
