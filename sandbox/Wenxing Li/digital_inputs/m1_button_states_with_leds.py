...
Much like we did in Wenxing Li of the motors unit, later we will show you different (better) ways to use buttons.
...
def main():
    ...
    #led_colors = [ev3.Leds.BLACK,  # This list is useful for the down
    # button in TO DO 4.
                  #ev3.Leds.GREEN,
                  #ev3.Leds.RED,
