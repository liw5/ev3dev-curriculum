...
Authors: David Fisher and Zhai Yihu.
...
def seek_beacon(robot):
    ...
    while not robot.touch_sensor.is_pressed:
        ...
        # distance.
        current_heading = robot.Beaconseeker.heading  # use the beacon_seeker heading
        current_distance = robot.Beaconseeker.distance  # use the beacon_seeker
        # distance
